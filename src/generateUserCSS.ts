...
export const generateUserCSS = async (settings: ThemeSettings) => {
  ...
  switch(themeMode) {
    ...
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-0:.+?;/gms, '  --s-notebook-folder-icon-0: hsl(var(--usp-remoods-hue), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-1:.+?;/gms, '  --s-notebook-folder-icon-1: hsl(calc(var(--usp-remoods-hue) + 50deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-2:.+?;/gms, '  --s-notebook-folder-icon-2: hsl(calc(var(--usp-remoods-hue) + 100deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-3:.+?;/gms, '  --s-notebook-folder-icon-3: hsl(calc(var(--usp-remoods-hue) + 150deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-4:.+?;/gms, '  --s-notebook-folder-icon-4: hsl(calc(var(--usp-remoods-hue) + 200deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-5:.+?;/gms, '  --s-notebook-folder-icon-5: hsl(calc(var(--usp-remoods-hue) + 250deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-6:.+?;/gms, '  --s-notebook-folder-icon-6: hsl(calc(var(--usp-remoods-hue) + 300deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-7:.+?;/gms, '  --s-notebook-folder-icon-7: hsl(calc(var(--usp-remoods-hue) + 350deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-8:.+?;/gms, '  --s-notebook-folder-icon-8: hsl(calc(var(--usp-remoods-hue) + 40deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-9:.+?;/gms, '  --s-notebook-folder-icon-9: hsl(calc(var(--usp-remoods-hue) + 90deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-10:.+?;/gms, '  --s-notebook-folder-icon-10: hsl(calc(var(--usp-remoods-hue) + 140deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-11:.+?;/gms, '  --s-notebook-folder-icon-11: hsl(calc(var(--usp-remoods-hue) + 190deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-12:.+?;/gms, '  --s-notebook-folder-icon-12: hsl(calc(var(--usp-remoods-hue) + 240deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-13:.+?;/gms, '  --s-notebook-folder-icon-13: hsl(calc(var(--usp-remoods-hue) + 290deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-14:.+?;/gms, '  --s-notebook-folder-icon-14: hsl(calc(var(--usp-remoods-hue) + 340deg), 80%, 60%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-15:.+?;/gms, '  --s-notebook-folder-icon-15: hsl(calc(var(--usp-remoods-hue) + 30deg), 80%, 60%);');
  ...
  case 'duskMode':
    ...
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-0:.+?;/gms, '  --s-notebook-folder-icon-0: hsl(var(--usp-remoods-hue), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-1:.+?;/gms, '  --s-notebook-folder-icon-1: hsl(calc(var(--usp-remoods-hue) + 50deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-2:.+?;/gms, '  --s-notebook-folder-icon-2: hsl(calc(var(--usp-remoods-hue) + 100deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-3:.+?;/gms, '  --s-notebook-folder-icon-3: hsl(calc(var(--usp-remoods-hue) + 150deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-4:.+?;/gms, '  --s-notebook-folder-icon-4: hsl(calc(var(--usp-remoods-hue) + 200deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-5:.+?;/gms, '  --s-notebook-folder-icon-5: hsl(calc(var(--usp-remoods-hue) + 250deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-6:.+?;/gms, '  --s-notebook-folder-icon-6: hsl(calc(var(--usp-remoods-hue) + 300deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-7:.+?;/gms, '  --s-notebook-folder-icon-7: hsl(calc(var(--usp-remoods-hue) + 350deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-8:.+?;/gms, '  --s-notebook-folder-icon-8: hsl(calc(var(--usp-remoods-hue) + 40deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-9:.+?;/gms, '  --s-notebook-folder-icon-9: hsl(calc(var(--usp-remoods-hue) + 90deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-10:.+?;/gms, '  --s-notebook-folder-icon-10: hsl(calc(var(--usp-remoods-hue) + 140deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-11:.+?;/gms, '  --s-notebook-folder-icon-11: hsl(calc(var(--usp-remoods-hue) + 190deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-12:.+?;/gms, '  --s-notebook-folder-icon-12: hsl(calc(var(--usp-remoods-hue) + 240deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-13:.+?;/gms, '  --s-notebook-folder-icon-13: hsl(calc(var(--usp-remoods-hue) + 290deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-14:.+?;/gms, '  --s-notebook-folder-icon-14: hsl(calc(var(--usp-remoods-hue) + 340deg), 100%, 70%);');
    chromeCSS = chromeCSS.replace(/^  --s-notebook-folder-icon-15:.+?;/gms, '  --s-notebook-folder-icon-15: hsl(calc(var(--usp-remoods-hue) + 30deg), 100%, 70%);');
