...
export const generateUserCSS = async (settings: ThemeSettings) => {
  ...
  switch(themeMode) {
    ...
    case 'dayMode':
      ...
      chromeCSS = chromeCSS.replace(/^  --me-scrollbar-track-bg:.+?;/gms, '  --me-scrollbar-track-bg: hsl(var(--usp-hue),   0%,  70%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --me-scrollbar-thumb-bg:.+?;/gms, '  --me-scrollbar-thumb-bg: linear-gradient(to bottom, hsl(var(--usp-hue),   0%,  70%)  3px, hsl(var(--usp-hue),   0%, 100%)  4px, hsl(var(--usp-hue),   0%, 100%) calc(100% - 4px), hsl(var(--usp-hue),   0%,  70%) calc(100% - 3px));');
      chromeCSS = chromeCSS.replace(/^  --me-scrollbar-thumb-bd:.+?;/gms, '  --me-scrollbar-thumb-bd: hsl(var(--usp-hue),   0%,  70%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --me-cursor-bdl:.+?;/gms, '  --me-cursor-bdl: 2px solid hsl(var(--usp-hue),   0%,   0%);');
      chromeCSS = chromeCSS.replace(/^  --me-selected-text:.+?;/gms, '  --me-selected-text: var(--me-text);');
      chromeCSS = chromeCSS.replace(/^  --me-selected-bg:.+?;/gms, '  --me-selected-bg: hsl(calc(var(--usp-hue) + 180deg), 100%,  90%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --me-mark-bd:.+?;/gms, '  --me-mark-bd: hsl(var(--usp-hue),  60%,  60%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --me-insert-bdb:.+?;/gms, '  --me-insert-bdb: hsl(var(--usp-hue),  25%,  75%);');
      chromeCSS = chromeCSS.replace(/^  --me-strikethrough-text:.+?;/gms, '  --me-strikethrough-text: hsl(var(--usp-hue),  25%,  75%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --me-inline-code-text:.+?;/gms, '  --me-inline-code-text: hsl(var(--usp-hue),   0%,  30%);');
      chromeCSS = chromeCSS.replace(/^  --me-inline-code-bg:.+?;/gms, '  --me-inline-code-bg: hsl(var(--usp-hue), 100%,  95%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --me-h1-text:.+?;/gms, '  --me-h1-text: hsl(var(--usp-hue),  60%,  60%);');
      chromeCSS = chromeCSS.replace(/^  --me-h2-text:.+?;/gms, '  --me-h2-text: hsl(var(--usp-hue),   0%,  30%);');
      chromeCSS = chromeCSS.replace(/^  --me-h3-text:.+?;/gms, '  --me-h3-text: hsl(var(--usp-hue),   0%,  30%);');
      chromeCSS = chromeCSS.replace(/^  --me-h4-text:.+?;/gms, '  --me-h4-text: hsl(var(--usp-hue),   0%,  30%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --me-code-block-bdc:.+?;/gms, '  --me-code-block-bdc: hsl(var(--usp-hue),  80%,  60%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --g-panel-header-bgc:.+?;/gms, '  --g-panel-header-bgc: hsl(var(--usp-hue), 100%,  80%);');
      chromeCSS = chromeCSS.replace(/^  --g-panel-header-text:.+?;/gms, '  --g-panel-header-text: hsl(var(--usp-hue),   0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --g-panel-header-ts:.+?;/gms, '  --g-panel-header-ts: none;');
      chromeCSS = chromeCSS.replace(/^  --g-item-bgc-hover:.+?;/gms, '  --g-item-bgc-hover: hsl(var(--usp-hue), 100%,  95%);');
      chromeCSS = chromeCSS.replace(/^  --g-item-bgc-selected:.+?;/gms, '  --g-item-bgc-selected: hsl(var(--usp-hue), 100%,  85%);');
      chromeCSS = chromeCSS.replace(/^  --g-item-ds-hover:.+?;/gms, '  --g-item-ds-hover: 2px hsl(var(--usp-hue), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --g-item-divider:.+?;/gms, '  --g-item-divider: hsl(var(--usp-hue),  40%,  80%);');
      chromeCSS = chromeCSS.replace(/^  --g-item-text:.+?;/gms, '  --g-item-text: hsl(var(--usp-hue), 0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --g-item-text-2:.+?;/gms, '  --g-item-text-2: hsl(var(--usp-hue), 0%,  20%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --g-scrollbar-thumb-bg:.+?;/gms, '  --g-scrollbar-thumb-bg: hsl(var(--usp-hue),   0%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --g-scrollbar-track-bg:.+?;/gms, '  --g-scrollbar-track-bg: hsl(var(--usp-hue),   0%,  90%);');
      chromeCSS = chromeCSS.replace(/^  --g-input-text:.+?;/gms, '  --g-input-text: hsl(var(--usp-hue),   0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --g-input-bg:.+?;/gms, '  --g-input-bg: hsl(var(--usp-hue),   0%, 100%);');
      chromeCSS = chromeCSS.replace(/^  --g-input-bd:.+?;/gms, '  --g-input-bd: hsl(var(--usp-hue),   0%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --g-toolbar-bg:.+?;/gms, '  --g-toolbar-bg: hsl(var(--usp-hue),   0%, 100%);');
      chromeCSS = chromeCSS.replace(/^  --g-toolbar-bd:.+?;/gms, '  --g-toolbar-bd: hsl(var(--usp-hue),   0%,  60%);');
      chromeCSS = chromeCSS.replace(/^  --g-ep-divider:.+?;/gms, '  --g-ep-divider: hsl(var(--usp-hue),   0%,  90%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-np-note-count-label-text:.+?;/gms, '  --s-np-note-count-label-text: hsl(var(--usp-hue),   0%,   0%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-note-count-label-bgc:.+?;/gms, '  --s-np-note-count-label-bgc: hsl(var(--usp-hue), 100%,  95%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-note-count-label-bd:.+?;/gms, '  --s-np-note-count-label-bd: hsl(var(--usp-hue),  50%,  50%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-nlp-todo-text:.+?;/gms, '  --s-nlp-todo-text: hsl(var(--usp-hue),  90%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-nlp-search-btn-icon:.+?;/gms, '  --s-nlp-search-btn-icon: hsl(var(--usp-hue),   0%,  70%);');
      // chromeCSS = chromeCSS.replace(/^  --s-ep-toolbar-ds:.+?;/gms, '  --s-ep-toolbar-ds:;');
      chromeCSS = chromeCSS.replace(/^  --s-ep-notebook-nav-btn-bg:.+?;/gms, '  --s-ep-notebook-nav-btn-bg: hsl(var(--usp-hue), 100%,  90%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-notebook-nav-btn-bd:.+?;/gms, '  --s-ep-notebook-nav-btn-bd: hsl(var(--usp-hue), 100%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-notebook-nav-btn-bs:.+?;/gms, '  --s-ep-notebook-nav-btn-bs: 3px hsl(var(--usp-hue),  70%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-notebook-nav-btn-text:.+?;/gms, '  --s-ep-notebook-nav-btn-text: hsl(var(--usp-hue), 100%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-batch-menu-btn-text:.+?;/gms, '  --s-ep-batch-menu-btn-text: hsl(var(--usp-hue),   0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-batch-menu-btn-bg:.+?;/gms, '  --s-ep-batch-menu-btn-bg: hsl(var(--usp-hue),   0%, 100%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-batch-menu-btn-bd:.+?;/gms, '  --s-ep-batch-menu-btn-bd: hsl(var(--usp-hue),  60%,  60%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-update-time-label-bg:.+?;/gms, '  --s-ep-update-time-label-bg: hsl(var(--usp-hue),   0%, 100%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-update-time-label-text:.+?;/gms, '  --s-ep-update-time-label-text: hsl(var(--usp-hue),  20%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-tagbar-tag-text:.+?;/gms, '  --s-ep-tagbar-tag-text: hsl(var(--usp-hue),  40%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-tagbar-tag-text-hover:.+?;/gms, '  --s-ep-tagbar-tag-text-hover: hsl(var(--usp-hue),  60%,  60%);');
      chromeCSS = chromeCSS.replace(/^  --s-ep-tagbar-tag-ts-hover:.+?;/gms, '  --s-ep-tagbar-tag-ts-hover: none;');
      chromeCSS = chromeCSS.replace(/^  --s-ep-tagbar-tag-divider:.+?;/gms, '  --s-ep-tagbar-tag-divider: hsl(var(--usp-hue),   0%,  70%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-md-label-text:.+?;/gms, '  --s-md-label-text: hsl(var(--usp-hue),   0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-title-text:.+?;/gms, '  --s-md-title-text: hsl(var(--usp-hue),   0%,  50%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-confirm-btn-text:.+?;/gms, '  --s-md-confirm-btn-text: hsl(var(--usp-hue),   0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-confirm-btn-bg:.+?;/gms, '  --s-md-confirm-btn-bg: hsl(var(--usp-hue),   0%, 100%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-confirm-btn-bd:.+?;/gms, '  --s-md-confirm-btn-bd: hsl(var(--usp-hue),  40%,  40%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-md-notebook-creator-icon-select-btn-bd:.+?;/gms, '  --s-md-notebook-creator-icon-select-btn-bd: hsl(var(--usp-hue), 100%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-notebook-creator-icon-select-btn-text:.+?;/gms, '  --s-md-notebook-creator-icon-select-btn-text: hsl(var(--usp-hue), 100%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-tag-selector-bg:.+?;/gms, '  --s-md-tag-selector-bg: hsl(var(--usp-hue), 100%,  95%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-tag-selector-bd:.+?;/gms, '  --s-md-tag-selector-bd: hsl(var(--usp-hue),  40%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-tag-selector-input-text:.+?;/gms, '  --s-md-tag-selector-input-text: hsl(var(--usp-hue),   0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-tag-selector-divider:.+?;/gms, '  --s-md-tag-selector-divider: hsl(var(--usp-hue),   0%,  80%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-tag-selector-text:.+?;/gms, '  --s-md-tag-selector-text: hsl(var(--usp-hue),   0%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-bg:.+?;/gms, '  --s-md-command-palette-item-bg: hsl(var(--usp-hue),   0%, 100%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-bg-selected:.+?;/gms, '  --s-md-command-palette-item-bg-selected: hsl(var(--usp-hue), 100%,  85%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-bdb:.+?;/gms, '  --s-md-command-palette-item-bdb: hsl(var(--usp-hue),   0%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-text:.+?;/gms, '  --s-md-command-palette-item-text: hsl(var(--usp-hue),   0%,   0%);');
      // chromeCSS = chromeCSS.replace(/^  --s-op-menu-subtitle-bg:.+?;/gms, '  --s-op-menu-subtitle-bg:;');
      chromeCSS = chromeCSS.replace(/^  --s-op-guide-text:.+?;/gms, '  --s-op-guide-text: hsl(var(--usp-hue),  40%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-guide-bg:.+?;/gms, '  --s-op-guide-bg: hsl(var(--usp-hue),  90%,  90%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-label-text:.+?;/gms, '  --s-op-label-text: hsl(var(--usp-hue),   0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-input-text:.+?;/gms, '  --s-op-input-text: hsl(var(--usp-hue),   0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-btn-bg:.+?;/gms, '  --s-op-btn-bg: hsl(var(--usp-hue), 100%,  90%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-btn-bd:.+?;/gms, '  --s-op-btn-bd: hsl(var(--usp-hue), 100%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-btn-text:.+?;/gms, '  --s-op-btn-text: hsl(var(--usp-hue), 100%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-description-text:.+?;/gms, '  --s-op-description-text: hsl(var(--usp-hue),  20%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-table-text:.+?;/gms, '  --s-op-table-text: hsl(var(--usp-hue),  20%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-plugin-card-bd:.+?;/gms, '  --s-op-plugin-card-bd: hsl(var(--usp-hue), 100%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-plugin-card-bs:.+?;/gms, '  --s-op-plugin-card-bs: none;');
      chromeCSS = chromeCSS.replace(/^  --s-op-plugin-card-text:.+?;/gms, '  --s-op-plugin-card-text: hsl(var(--usp-hue),   0%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-plugin-card-switcher-bg:.+?;/gms, '  --s-op-plugin-card-switcher-bg: hsl(var(--usp-hue), 100%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-confirm-btn-bg:.+?;/gms, '  --s-op-confirm-btn-bg: hsl(var(--usp-hue), 100%,  80%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-confirm-btn-bd:.+?;/gms, '  --s-op-confirm-btn-bd: hsl(var(--usp-hue), 100%,  90%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-confirm-btn-bs:.+?;/gms, '  --s-op-confirm-btn-bs: hsl(var(--usp-hue), 100%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-confirm-btn-text:.+?;/gms, '  --s-op-confirm-btn-text: hsl(var(--usp-hue),  20%,  20%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-scrollbar-thumb-bg:.+?;/gms, '  --sc-scrollbar-thumb-bg: hsl(var(--usp-hue),   0%,  70%);');
      noteCSS = noteCSS.replace(/^  --sc-hr-bgc:.+?;/gms, '  --sc-hr-bgc: none;');
      noteCSS = noteCSS.replace(/^  --sc-hr-bgi:.+?;/gms, '  --sc-hr-bgi: repeating-linear-gradient(114deg, hsl(var(--usp-hue), 100%,  30%), hsl(var(--usp-hue), 100%,  75%,  50%), hsl(var(--usp-hue), 100%,  30%) 3px);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-insert-text:.+?;/gms, '  --sc-insert-text: hsl(var(--usp-hue),  25%,  50%);');
      noteCSS = noteCSS.replace(/^  --sc-insert-bg:.+?;/gms, '  --sc-insert-bg: none;');
      noteCSS = noteCSS.replace(/^  --sc-insert-bdb:.+?;/gms, '  --sc-insert-bdb: hsl(var(--usp-hue),  25%,  75%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-inline-code-text:.+?;/gms, '  --sc-inline-code-text: hsl(var(--usp-hue),   0%,  30%);');
      noteCSS = noteCSS.replace(/^  --sc-inline-code-bg:.+?;/gms, '  --sc-inline-code-bg: hsl(var(--usp-hue), 100%,  95%);');
      noteCSS = noteCSS.replace(/^  --sc-inline-code-symbol:.+?;/gms, '  --sc-inline-code-symbol: hsl(var(--usp-hue),  20%,  60%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-h1-text:.+?;/gms, '  --sc-h1-text: hsl(var(--usp-hue),  60%,  60%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-h2-text:.+?;/gms, '  --sc-h2-text: hsl(var(--usp-hue),   0%,  30%);');
      noteCSS = noteCSS.replace(/^  --sc-h2-bgi:.+?;/gms, '  --sc-h2-bgi: linear-gradient(to right, hsl(var(--usp-hue),   0%,  30%) 50%, transparent);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-art-gallery-bg:.+?;/gms, '  --sc-art-gallery-bg: hsl(var(--usp-hue), 98%,  98%);');
      noteCSS = noteCSS.replace(/^  --sc-art-gallery-bdc:.+?;/gms, '  --sc-art-gallery-bdc: hsl(var(--usp-hue), 100%,  45%);');
      noteCSS = noteCSS.replace(/^  --sc-art-gallery-ds:.+?;/gms, '  --sc-art-gallery-ds: 2px hsl(var(--usp-hue), 100%,  35%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-sticky-notes-bdc:.+?;/gms, '  --sc-sticky-notes-bdc: hsl(var(--usp-hue), 100%,  45%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-custom-title-block-ds:.+?;/gms, '  --sc-custom-title-block-ds: 2px hsl(var(--usp-hue), 100%,  45%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-key-mention-bd:.+?;/gms, '  --sc-key-mention-bd: 1px solid hsl(var(--usp-hue),  60%,  60%);');
      ...
      if(!h1TwillPattern) {
        ...
        noteCSS = noteCSS.replace(/^  --sc-h1-bgi:.+?;/gms, '  --sc-h1-bgi: linear-gradient(to right, hsl(var(--usp-hue),  60%,  60%) 50%, transparent);');
      } else {
      ...
      if(!dottedBlockquote) {
        noteCSS = noteCSS.replace(/^  --sc-blockquote-bdl:.+?;/gms, '  --sc-blockquote-bdl: 3px solid hsl(var(--usp-hue),  50%,  85%);');
        noteCSS = noteCSS.replace(/^  --pr-blockquote-bdl:.+?;/gms, '  --pr-blockquote-bdl: 2px solid hsl(var(--usp-hue),  20%,  60%);');
      } else {
        noteCSS = noteCSS.replace(/^  --sc-blockquote-bdl:.+?;/gms, '  --sc-blockquote-bdl: 5px dotted hsl(var(--usp-hue),  50%,  85%);');
    ...
    case 'duskMode':
      ...
      chromeCSS = chromeCSS.replace(/^  --me-syntax-bg:.+?;/gms, '  --me-syntax-bg: hsl(var(--usp-hue), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --me-cursor-bdl:.+?;/gms, '  --me-cursor-bdl: 2px solid hsl(var(--usp-hue), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --me-selected-text:.+?;/gms, '  --me-selected-text: var(--me-text);');
      chromeCSS = chromeCSS.replace(/^  --me-selected-bg:.+?;/gms, '  --me-selected-bg: hsl(calc(var(--usp-hue) + 180deg),  10%,  50%,  50%);');
      chromeCSS = chromeCSS.replace(/^  --me-special-text:.+?;/gms, '  --me-special-text: hsl(var(--usp-hue), 100%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --me-special-bg:.+?;/gms, '  --me-special-bg: hsl(var(--usp-hue),  30%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --me-mark-bd:.+?;/gms, '  --me-mark-bd: hsl(var(--usp-hue), 100%,  50%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --g-item-text:.+?;/gms, '  --g-item-text: hsl(var(--usp-hue), 100%,  98%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-ep-tagbar-tag-ts-hover:.+?;/gms, '  --s-ep-tagbar-tag-ts-hover: 2px hsl(var(--usp-hue), 100%,  25%);');
      ...
      // chromeCSS = chromeCSS.replace(/^  --s-op-menu-subtitle-bg:.+?;/gms,  '')
    ...
    case 'nightMode':
      ...
      chromeCSS = chromeCSS.replace(/^  --me-scrollbar-track-bg:.+?;/gms, '  --me-scrollbar-track-bg: hsl(var(--usp-hue),  70%,  70%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --me-scrollbar-thumb-bg:.+?;/gms, '  --me-scrollbar-thumb-bg: linear-gradient(to bottom, hsl(var(--usp-hue),  55%,  45%)  3px, hsl(var(--usp-hue),  11%,  13%) 4px, hsl(var(--usp-hue),  11%,  13%) calc(100% - 4px), hsl(var(--usp-hue),  55%,  45%) calc(100% - 3px));');
      chromeCSS = chromeCSS.replace(/^  --me-scrollbar-thumb-bd:.+?;/gms, '  --me-scrollbar-thumb-bd: hsl(var(--usp-hue),  55%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --me-hr-syntax-text:.+?;/gms, '  --me-hr-syntax-text: hsl(var(--usp-hue),   0%,  90%);');
      chromeCSS = chromeCSS.replace(/^  --me-hr-syntax-bg:.+?;/gms, '  --me-hr-syntax-bg: hsl(var(--usp-hue), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --me-cursor-bdl:.+?;/gms, '  --me-cursor-bdl: 2px solid hsl(var(--usp-hue), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --me-selected-text:.+?;/gms, '  --me-selected-text: var(--me-text);');
      chromeCSS = chromeCSS.replace(/^  --me-selected-bg:.+?;/gms, '  --me-selected-bg: hsl(calc(var(--usp-hue) + 180deg),  20%,  30%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --me-mark-bd:.+?;/gms, '  --me-mark-bd: hsl(var(--usp-hue),  70%,  60%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --me-code-block-invalidchar-ts:.+?;/gms, '  --me-code-block-invalidchar-ts: none;');
      chromeCSS = chromeCSS.replace(/^  --me-code-block-variable-text:.+?;/gms, '  --me-code-block-variable-text: hsl(var(--usp-hue),   0%,  80%);');
      chromeCSS = chromeCSS.replace(/^  --me-code-block-variable-ts:.+?;/gms, '  --me-code-block-variable-ts: none;');
      chromeCSS = chromeCSS.replace(/^  --me-code-block-variable-2-text:.+?;/gms, '  --me-code-block-variable-2-text: var(--me-code-block-variable-text);');
      chromeCSS = chromeCSS.replace(/^  --me-code-block-variable-2-ts:.+?;/gms, '  --me-code-block-variable-2-ts: var(--me-code-block-variable-ts);');
      chromeCSS = chromeCSS.replace(/^  --me-code-block-def-text:.+?;/gms, '  --me-code-block-def-text: var(--me-code-block-variable-text);');
      ...
      chromeCSS = chromeCSS.replace(/^  --g-panel-header-bgc:.+?;/gms, '  --g-panel-header-bgc: hsl(var(--usp-hue),  55%,  45%);');
      chromeCSS = chromeCSS.replace(/^  --9-panel-header-text:.+?;/gms, '  --g-panel-header-text: hsl(var(--usp-hue),   0%,  88%);');
      chromeCSS = chromeCSS.replace(/^  --g-panel-header-ts:.+?;/gms, '  --g-panel-header-ts: 3px hsl(var(--usp-hue),   0%,   0%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --g-scrollbar-thumb-bg:.+?;/gms, '  --g-scrollbar-thumb-bg: hsl(var(--usp-hue),  55%,  45%);');
      chromeCSS = chromeCSS.replace(/^  --g-scrollbar-track-bg:.+?;/gms, '  --g-scrollbar-track-bg: hsl(var(--usp-hue),  20%,  20%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-panel-divider:.+?;/gms, '  --s-panel-divider: hsl(var(--usp-hue),  14%,  11%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-directory-icon-open:.+?;/gms, '  --s-np-directory-icon-open: hsl(var(--usp-hue),  20%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-directory-icon-open-ds:.+?;/gms, '  --s-np-directory-icon-open-ds: hsl(var(--usp-hue), 100%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-directory-icon-close:.+?;/gms, '  --s-np-directory-icon-close: hsl(calc(var(--usp-hue) + 180deg), 100%,  65%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-directory-icon-close-ds:.+?;/gms, '  --s-np-directory-icon-close-ds: hsl(calc(var(--usp-hue) + 180deg), 100%,  60%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-notebook-folder-icon-0:.+?;/gms, '  --s-np-notebook-folder-icon-0: hsl(var(--usp-hue), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-notebook-folder-icon-1:.+?;/gms, '  --s-np-notebook-folder-icon-1: hsl(calc(var(--usp-hue) + 50deg), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-notebook-folder-icon-2:.+?;/gms, '  --s-np-notebook-folder-icon-2: hsl(calc(var(--usp-hue) + 100deg), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-notebook-folder-icon-3:.+?;/gms, '  --s-np-notebook-folder-icon-3: hsl(calc(var(--usp-hue) + 150deg), 100%,  70%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-np-notebook-folder-icon-15:.+?;/gms, '  --s-np-notebook-folder-icon-15: hsl(calc(var(--usp-hue) + 30deg), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-note-count-label-text:.+?;/gms, '  --s-np-note-count-label-text: hsl(var(--usp-hue),   0%, 100%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-note-count-label-bgc:.+?;/gms, '  --s-np-note-count-label-bgc: hsl(var(--usp-hue),  60%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-note-count-label-bd:.+?;/gms, '  --s-np-note-count-label-bd: hsl(var(--usp-hue),  50%,  80%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-note-count-label-ds:.+?;/gms, '  --s-np-note-count-label-ds: 1px hsl(var(--usp-hue), 100%,  80%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-sync-info-text:.+?;/gms, '  --s-np-sync-info-text: hsl(var(--usp-hue), 100%,  95%);');
      chromeCSS = chromeCSS.replace(/^  --s-np-sync-info-symbol:.+?;/gms, '  --s-np-sync-info-symbol: radial-gradient(hsl(var(--usp-hue), 100%,  80%) 25%, hsl(var(--usp-hue), 100%,  50%) 55%, hsl(var(--usp-hue), 100%,  80%) 80%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-scrollbar-thumb-bg:.+?;/gms, '  --sc-scrollbar-thumb-bg: hsl(var(--usp-hue), 55%, 45%);');
      noteCSS = noteCSS.replace(/^  --sc-hr-bgc:.+?;/gms, '  --sc-hr-bgc: none;');
      noteCSS = noteCSS.replace(/^  --sc-hr-bgi:.+?;/gms, '  --sc-hr-bgi: repeating-linear-gradient(114deg, hsl(var(--usp-hue), 100%,  80%), hsl(var(--usp-hue), 100%,  35%,  50%), hsl(var(--usp-hue), 100%,  80%)  3px);');
      noteCSS = noteCSS.replace(/^  --sc-block-content-scrollbar-thumb-bd:.+?;/gms, '  --sc-block-content-scrollbar-thumb-bd: transparent;');
      ...
      noteCSS = noteCSS.replace(/^  --sc-mark-bg:.+?;/gms, '  --sc-mark-bg: hsl(var(--usp-hue),  70%,  70%);');
      noteCSS = noteCSS.replace(/^  --sc-search-text:.+?;/gms, '  --sc-search-text: hsl(var(--usp-hue),   0%, 100%);');
      noteCSS = noteCSS.replace(/^  --sc-search-bg:.+?;/gms, '  --sc-search-bg: hsl(var(--usp-hue),   0%,   0%);');
      noteCSS = noteCSS.replace(/^  --sc-search-bd:.+?;/gms, '  --sc-search-bd: hsl(0, 100%,  50%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-table-text:.+?;/gms, '  --sc-table-text: var(--sc-text);');
      noteCSS = noteCSS.replace(/^  --sc-table-bd:.+?;/gms, '  --sc-table-bd: 2px solid var(--sc-bg-1);');
      noteCSS = noteCSS.replace(/^  --sc-table-header-bg:.+?;/gms, '  --sc-table-header-bg: hsl(var(--usp-hue),  70%,  30%);');
      noteCSS = noteCSS.replace(/^  --sc-table-header-ts:.+?;/gms, '  --sc-table-header-ts: 2px black;');
