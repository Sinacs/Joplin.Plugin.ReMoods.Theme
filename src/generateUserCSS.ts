...
export const generateUserCSS = async (settings: ThemeSettings) => {
  ...
  switch(themeMode) {
    ...
    case 'dayMode':
      ...
      chromeCSS = chromeCSS.replace(/^  --s-ep-tagbar-tag-text:.+?;/gms, '  --s-ep-tagbar-tag-text: hsl(var(--usp-hue),  20%,  40%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-op-menu-subtitle-bg:.+?;/gms, '  --s-op-menu-subtitle-bg: hsl(var(--usp-hue), 100%,  10%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-guide-text:.+?;/gms, '  --s-op-guide-text: hsl(var(--usp-hue),  50%,  30%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-guide-bg:.+?;/gms, '  --s-op-guide-bg: hsl(var(--usp-hue),  50%,  85%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-label-text:.+?;/gms, '  --s-op-label-text: hsl(var(--usp-hue),  20%,  30%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-input-text:.+?;/gms, '  --s-op-input-text: hsl(var(--usp-hue),  20%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-btn-bg:.+?;/gms, '  --s-op-btn-bg: hsl(var(--usp-hue), 100%,  10%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-btn-bd:.+?;/gms, '  --s-op-btn-bd: hsl(var(--usp-hue),  40%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-btn-text:.+?;/gms, '  --s-op-btn-text: hsl(var(--usp-hue),  80%,  80%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-description-text:.+?;/gms, '  --s-op-description-text: hsl(var(--usp-hue),  20%,  50%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-op-plugin-card-text:.+?;/gms, '  --s-op-plugin-card-text: hsl(var(--usp-hue),  20%,  30%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-plugin-card-switcher-bg:.+?;/gms, '  --s-op-plugin-card-switcher-bg: hsl(var(--usp-hue),  70%,  80%);');
      chromeCSS = chromeCSS.replace(/^  --s-op-confirm-btn-bg:.+?;/gms, '  --s-op-confirm-btn-bg: hsl(var(--usp-hue), 100%,  10%);');
