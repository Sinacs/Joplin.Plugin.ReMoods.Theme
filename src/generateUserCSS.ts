...
export const generateUserCSS = async (settings: ThemeSettings) => {
  ...
  switch(themeMode) {
    ...
    case 'dayMode':
      ...
      chromeCSS = chromeCSS.replace(/^  --me-selected-bg:.+?;/gms, '  --me-selected-bg: hsl(calc(var(--usp-hue) + 180deg),  20%,  90%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-bg-selected:.+?;/gms, '  --s-md-command-palette-item-bg-selected: hsl(var(--usp-hue),  50%,  95%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-bdb:.+?;/gms, '  --s-md-command-palette-item-bdb: hsl(var(--usp-hue),  20%,  75%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-title:.+?;/gms, '  --s-md-command-palette-item-title: hsl(calc(var(--usp-hue) + 180deg), 100%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-text:.+?;/gms, '  --s-md-command-palette-item-text: hsl(var(--usp-hue), 100%,  20%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-matching-text:.+?;/gms, '  --s-md-command-palette-item-matching-text: hsl(  0,   0%,   0%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-matching-bdc:.+?;/gms, '  --s-md-command-palette-item-matching-bdc: hsl(calc(var(--usp-hue) + 180deg), 100%,  85%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-plugin-code-clipboard-btn:.+?;/gms, '  --sc-plugin-code-clipboard-btn: hsl(var(--usp-hue),   0%,  95%);');
    ...
    case 'duskMode':
      ...
      chromeCSS = chromeCSS.replace(/^  --g-input-text:.+?;/gms, '  --g-input-text: hsl(var(--usp-hue), 100%,  90%);');
      ...
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-bg-selected:.+?;/gms, '  --s-md-command-palette-item-bg-selected: hsl(var(--usp-hue),  30%,  30%,  40%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-bdb:.+?;/gms, '  --s-md-command-palette-item-bdb: hsl(var(--usp-hue),  30%,  30%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-title:.+?;/gms, '  --s-md-command-palette-item-title: hsl(calc(var(--usp-hue) + 180deg), 100%, 75%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-text:.+?;/gms, '  --s-md-command-palette-item-text: hsl(var(--usp-hue), 100%,  90%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-matching-text:.+?;/gms, '  --s-md-command-palette-item-matching-text: hsl(  0,   0%,   0%);');
      chromeCSS = chromeCSS.replace(/^  --s-md-command-palette-item-matching-bdc:.+?;/gms, '  --s-md-command-palette-item-matching-bdc: hsl(calc(var(--usp-hue) + 180deg), 100%,  85%);');
      ...
      noteCSS = noteCSS.replace(/^  --sc-plugin-code-clipboard-btn:.+?;/gms, '  --sc-plugin-code-clipboard-btn: hsl(var(--usp-hue),   0%,  30%);');
    ...
    case 'nightMode':
      ...
      chromeCSS = chromeCSS.replace(/^  --me-cursor-bdl:.+?;/gms, '  --me-cursor-bdl: 2px solid hsl(var(--usp-hue), 100%,  70%);');
      chromeCSS = chromeCSS.replace(/^  --me-selected-text:.+?;/gms, '  --me-selected-text: var(--me-text);');
      chromeCSS = chromeCSS.replace(/^  --me-selected-bg:.+?;/gms, '  --me-selected-bg: hsl(calc(var(--usp-hue) + 180deg),   5%,  30%);');
      chromeCSS = chromeCSS.replace(/^  --me-selected-bg-focused:.+?;/gms, '  --me-selected-bg-focused: hsl(calc(var(--usp-hue) + 180deg),   5%,  30%);');
